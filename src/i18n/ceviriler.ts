...
const anaSayfa = {
  tr: {
    ...
    anladim: 'Anladım',
    pilUyarisiBaslik: 'Bildirimler kesintisiz çalışsın',
    pilUyarisiAciklama: 'Telefonun pil optimizasyonu, uygulama kapalıyken ezan bildirimlerinin gecikmesine yol açabiliyor. Vaktinde bildirim için tek bir ayarı açman yeterli:',
    pilKisitlamasiniKaldir: 'Pil kısıtlamasını kaldır',
  ...
  en: {
    ...
    anladim: 'Got It',
    pilUyarisiBaslik: 'Keep notifications running smoothly',
    pilUyarisiAciklama: "Your phone's battery optimization can delay prayer time notifications while the app is closed. One setting fixes on-time notifications:",
    pilKisitlamasiniKaldir: 'Remove battery restriction',
  ...
  id: {
    ...
    anladim: 'Mengerti',
    pilUyarisiBaslik: 'Biarkan notifikasi berjalan tanpa gangguan',
    pilUyarisiAciklama: 'Optimisasi baterai ponselmu bisa menyebabkan notifikasi waktu salat tertunda saat aplikasi ditutup. Cukup aktifkan satu pengaturan ini untuk notifikasi tepat waktu:',
    pilKisitlamasiniKaldir: 'Hapus batasan baterai',
  ...
  fr: {
    ...
    anladim: 'Compris',
    pilUyarisiBaslik: 'Laisser les notifications fonctionner sans interruption',
    pilUyarisiAciklama: "L'optimisation de la batterie de ton téléphone peut retarder les notifications de prière quand l'application est fermée. Un seul réglage suffit pour des notifications à l'heure :",
    pilKisitlamasiniKaldir: 'Supprimer la restriction de batterie',
...
const ayarlar = {
  tr: {
    ...
    genelBaslik: 'Genel',
    titresim: 'Titreşim',
    uygulamayiDegerlendir: 'Uygulamayı Değerlendir',
    uygulamayiDegerlendirAciklama: 'Google Play\'de puan ver, başkalarının da bulmasına yardım et',
    ...
    dakikaOnceBaslik: 'Kaç dakika önce uyarılmak istersin?',
  ...
  en: {
    ...
    genelBaslik: 'General',
    titresim: 'Vibration',
    uygulamayiDegerlendir: 'Rate the App',
    uygulamayiDegerlendirAciklama: 'Rate us on Google Play and help others find the app',
    ...
    dakikaOnceBaslik: 'How many minutes before do you want to be alerted?',
  ...
  id: {
    ...
    genelBaslik: 'Umum',
    titresim: 'Getaran',
    uygulamayiDegerlendir: 'Beri Nilai Aplikasi',
    uygulamayiDegerlendirAciklama: 'Beri nilai di Google Play dan bantu orang lain menemukan aplikasi ini',
    ...
    dakikaOnceBaslik: 'Berapa menit sebelumnya kamu ingin diperingatkan?',
  ...
  fr: {
    ...
    genelBaslik: 'Général',
    titresim: 'Vibration',
    uygulamayiDegerlendir: 'Évaluer l\'application',
    uygulamayiDegerlendirAciklama: 'Note-nous sur Google Play et aide les autres à trouver l\'application',
    ...
    dakikaOnceBaslik: 'Combien de minutes avant veux-tu être averti ?',
