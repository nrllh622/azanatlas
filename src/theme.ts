...
export const PALETLER: Record<string, PaletTanimi> = {
  ...
  lilaTezhibi: {
    ...
    renkler: {
      ...
      // Madde 7 (devir dosyası — ısrarla tekrarlanan şikayet): önceki
      // karartma yetersiz kalmıştı. Bu üçü (primaryGlow, gold/copperLight,
      // textOnDarkMuted) koyu zeminde METİN olarak kullanıldığı için en çok
      // göz yoran değerlerdi — WCAG AA eşiği (≥3:1 büyük metin / ≥4.5:1
      // gövde metni, primary/primaryDark/primaryDeep'e karşı ölçüldü)
      // korunarak belirgin biçimde koyulaştırıldı.
      primaryGlow: '#695C9D',
      primarySoft: '#D6D1EC',
      primaryMist: '#EEEBF8',
      cream: '#FBF7EE',
  ...
  zumrutVarak: {
    ...
    renkler: {
      ...
      // Madde 7: bkz. lilaTezhibi'ndeki açıklama — aynı gerekçeyle koyulaştırıldı.
      primaryGlow: '#3E9461',
      primarySoft: '#C3E9D1',
      primaryMist: '#E7F5EB',
      cream: '#FBF7EA',
